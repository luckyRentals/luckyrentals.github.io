...
$(function () {
    ...
    photoHelper.retrieveWelcomePhotos({
        onSuccess: function (data) {
            generatePropertiesCarasolHtml(data);
        }
    });
});
...
function generateFeaturedHomeHtml(featuredHome) {
    ...
    $(viewPropertyButton).on("click", function () {
        window.location.href = "property.html?pk=" + featuredHome.key();
    });
